...
namespace Vetstore.MVC.Controllers
{
    public class VentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VentaId,MedioPagoId,LocalId,AtencionId")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VentaId,MedioPagoId,LocalId,AtencionId")] Venta venta)
        {
            if (ModelState.IsValid)
            {
