...
namespace Vetstore.MVC.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartamentoId,UbigeoId")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartamentoId,UbigeoId")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
